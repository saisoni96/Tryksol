...
from .views import SendOTPView,VerifyOTPView, LogoutView,UserRegisterView,UserLoginView,ResetPasswdView, CategoryListView, quizListView, Results,FetchNewQuiz,SaveQuizResponse,ResultDetails
